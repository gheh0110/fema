...
import 'package:fema/helper/firebase_service.dart';
...
class _CompleteProfileFormState extends State<CompleteProfileForm> {
  ...
  //final dbRef = FirebaseDatabase(databaseURL: 'https://fema-0103-default-rtdb.asia-southeast1.firebasedatabase.app/').reference().child("users/");
